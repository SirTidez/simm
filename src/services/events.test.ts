...
describe('events', () => {
  ...
  it.each([
    ...
    ['onMelonLoaderInstalling', onMelonLoaderInstalling, 'melonloader_installing', { downloadId: 'd-1', environmentId: 'env-1', message: 'installing' }],
    ['onMelonLoaderInstalled', onMelonLoaderInstalled, 'melonloader_installed', { downloadId: 'd-1', environmentId: 'env-1', message: 'done', version: '1.0.0' }],
    ['onMelonLoaderError', onMelonLoaderError, 'melonloader_error', { downloadId: 'd-1', environmentId: 'env-1', message: 'err' }],
    ['onMelonLoaderUpdateAvailable', onMelonLoaderUpdateAvailable, 'melonloader_update_available', { latestVersion: 'v0.7.4', releaseName: 'MelonLoader v0.7.4', releaseUrl: 'https://example.com', targets: [] }],
