...
- Improved runtime resilience by handling replayed Nexus OAuth callbacks safely and detecting uploaded mod archive types from file signatures before install/update flows proceed.
