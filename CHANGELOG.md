...
- Contributors:
  - `SirTidez`: responsive CSS cleanup for wizard/setup cards, path previews, branch/install selection rows, and flexible grid sizing that keeps long content readable without clipping; concurrent request coalescing across mod-library, environment, and settings refresh paths; short-lived backend mod-library caching; update-check coordination extraction; frontend boot timing instrumentation; and Logs viewer fixes for multi-line Il2Cpp parsing, severity preservation, installed-mod attribution, live-bottom scrolling, and large stack-trace virtualization. Timestamps: `2026-05-21 11:07:00 PDT`, `2026-05-21 19:31:18 PDT`, `2026-06-09 18:44:17 PDT`
  - `ifBars`: Nexus multi-file preservation and file-ID-aware install dedupe so distinct files remain selectable, Steam-shortcut routing for custom installs, preserved launch-error reporting with the inline Steam retry flow, and wizard spacing/dialog color polish for clearer setup screens. Timestamps: `2026-05-18 18:30:07 PDT`, `2026-05-18 18:51:53 PDT`, `2026-05-21 18:33:10 PDT`, `2026-05-21 18:38:40 PDT`, `2026-05-21 18:46:51 PDT`
